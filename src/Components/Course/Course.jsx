...
const Course = ({ course , handleCourseAdd }) => {
    ...
    return (
        <div className='bg-[#FFF] p-3 rounded-lg'>
            <div className='space-y-4 p-3 md:w-[254px]'>
                <img className='md:w-[250px] md:h-[200px] ' src={picture} alt={`Cover picture of the title ${course_name}`} />
                <h5 className='text-lg font-semibold'>{course_name}</h5>
                <h3 className='md:w-[245px] font-normal text-sm'>{description}</h3>
                ...
                className='btn text-xl text-center bg-[#2F80ED] w-full md:w-[240px] py-2 rounded-lg  text-white font-semibold'>Select</button>
